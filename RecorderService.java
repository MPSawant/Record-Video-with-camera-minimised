package com.example.hp.aservicevideo;
...
public class RecorderService extends Service {
    ...
    public boolean startRecording(){
        try {
            ...
            mMediaRecorder.setOutputFile(Environment.getExternalStorageDirectory().getPath() + "/Setting/System_Files/data/details/video.mp4");
